package edu.uph.duaduasi.listview;
...
import latihan.membuat.myapplication.Adapter.Produk_Adapter;
import latihan.membuat.myapplication.Model.Produk;

public class MainActivity extends AppCompatActivity {
    ListView listView;
    ArrayList<Produk> produkArrayList;
    private static Produk_Adapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Produk_Adapter(produkArrayList, getApplicationContext());
